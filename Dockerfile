...
RUN apt-get update && \
    apt-get install -y wget libnotify4 libnss3 libxss1 libasound2 libappindicator3-1 libxtst6 libgstreamer1.0-0 libgstreamer-plugins-base1.0-0 libatomic1 libxcb-cursor0 && \
